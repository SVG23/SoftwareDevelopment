##This script is used to scrape the data from "http://www.pro-football-reference.com/teams/nwe/2016.htm" and create a usable data frame
##Gather team statistics on the New England Patriots
...
##Subset to get data frames for only the Patriots not the opponents stats
team_df <- data_df[data_df$Team=="Team Stats",]

##Write the data into csv
setwd("C:\\Users\\kotve002\\Documents\\Patriots")
